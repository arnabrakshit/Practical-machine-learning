...
There is additional code within the knitr markdown file here.
...
Several columns appeared to be entirely metadata. These columns were dropped as any correlation that exists would likely be spurious and therefore cause the model to perform poorly.
